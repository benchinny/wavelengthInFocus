function oi = noOpticsSICompute(scene, oi)
% Calculate OI irradiance without optics. Identical to opticsSIcompute from
% ISETBIO except it skips the optics step.
%
% Syntax:
%   oi = noOpticsSICompute(scene, oi)
%
% Description:
