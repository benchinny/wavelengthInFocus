function [otf, achOTF] = humanCoreARC(wave, sampleSF, p, D0, LCAshift)
%  Compute the human optical transfer function
%
% Syntax:
%   [otf, achOTF] = humanCoreARC(wave, nWave, sampleSF, p, D0)
%
% Description:
%    Calculate the human OTF.
%
%    This function contains examples of usage inline. To access, type 'edit
%    humanCoreARC.m' into the Command Window.
%
% Inputs:
