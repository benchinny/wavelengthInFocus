...
function ARCtestWvInFocusMeanZstrehlLminusMeffectFitOnly(subjNum,dataPath)
...
save([coneWeightsFolder 'S' num2str(subjNum) 'wvInFocusModelResultsLminusMstrehl.mat'],'RMSEall','wLM','wLprop');
