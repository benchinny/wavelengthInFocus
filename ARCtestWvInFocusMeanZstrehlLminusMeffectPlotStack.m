function [aic, pFit, wvMeanAll, wvPredAll, dfPredPurple, wLMmin, wLpropMin] = ARCtestWvInFocusMeanZstrehlLminusMeffectPlotStack(subjNum,modelType,dataPath)
...
for l = 1:length(wL)
    for k = 1:length(wM)
        ...
        [~, defocus875mean, defocus875predTmp, rgbUnq, optDistUnq] = ARCtestWvInFocusMeanZstrehlPlotHelper(subjNum,defocus875,rgbAll,optDistAll,[wL(l) wM(k) wS],dataPath);
